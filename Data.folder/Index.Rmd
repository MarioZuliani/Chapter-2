...
```{r}
###Figure 1
figure1 <- ggarrange(Abundance, Richness, Evenness, ncol = 1, align = "v", heights = 10)
figure1
```
```{r}
...
e27
tab_model(m24)
e1000 <- emmeans(m24, pairwise~microsite:RDM)
e1000
```
...
site.wide.map2 <- site.wide.map2 +
  geom_point(data=site.4, aes(x=site.lng, y=site.lat, color = Site), alpha = 1, size =6, show.legend = FALSE) +
