...
```{r}
ggplot(shorttransect, aes(site.density, Species)) + geom_boxplot() + ylab("Species Richness")
ggplot(shorttransect, aes(site.density, Even)) + geom_boxplot() + ylab("Species Richness")
