...
```{r}
###Figure 1
ggarrange(Abundance, Richness, evenness, nrow = 2, ncol = 2)
```
...
carrizo4 <- get_map(location = c(lon = -119.6287, lat = 35.11941), zoom = 16, maptype = "satellite")
carrizo4
...
carrizo3 <- get_map(location = c(lon = -119.67255, lat = 35.16180), zoom = 16, maptype = "satellite")
carrizo3
...
site.wide.map <- site.wide.map +
  ...
  labs(title = "Site Location", x = "longitude", y = "latitude")
site.wide.map
```
